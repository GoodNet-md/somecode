...
//  Sample usage:
//-------------------------------------------------------------------------------------------------------------------
uint16 encoder_angle_spi_1(PIN_enum cs_pin)
{
    uint16 angle;
    static uint16 old_angle = 0 ,new_angle = 0;
    int16 angle_diff;
    ...
    angle = angle>>4;
      ...
      angle_diff = (old_angle - new_angle);
                            //保存这次
      if (angle_diff > 2048)
          angle_diff = old_angle - 4095 - new_angle;
      if (angle_diff < -2048)
          angle_diff = old_angle + 4095 - new_angle;
      old_angle = new_angle;
      return angle_diff;
}
uint16 encoder_angle_spi_2(PIN_enum cs_pin)
{
    uint16 angle;
    static uint16 old_angle = 0 ,new_angle = 0;
    int16 angle_diff;
...
uint16 encoder_angle_spi_3(PIN_enum cs_pin)
{
    uint16 angle;
    static uint16 old_angle = 0 ,new_angle = 0;
    int16 angle_diff;
    ...
    angle = angle>>4;
      ...
      if (angle_diff > 2048)
          angle_diff = old_angle - 4095 - new_angle;
      if (angle_diff < -2048)
          angle_diff = old_angle + 4097 - new_angle;
      old_angle = new_angle;
      return angle_diff;
}
uint16 encoder_angle_spi_4(PIN_enum cs_pin)
{
    uint16 angle;
    static uint16 old_angle = 0 ,new_angle = 0;
    int16 angle_diff;
...
int16 encoder1_speed_spi(PIN_enum cs_pin)
{
    ...
    if(fabs(angle_diff) > 512)
    {
        if(old_angle<512) angle_diff = old_angle + (1024 - new_angle);
        if(old_angle>512) angle_diff = new_angle + (1024 - old_angle);
    }
